...
if QuestReaderAddon_RegisterSoundPack then
    QuestReaderAddon_RegisterSoundPack(addonName, QuestReaderSoundLengths_Pack_WrathoftheLichKing)
else
    QuestReaderPendingSoundPacks = QuestReaderPendingSoundPacks or {}
    table.insert(QuestReaderPendingSoundPacks,
        { name = addonName, index = QuestReaderSoundLengths_Pack_WrathoftheLichKing })
end
